...
@echo off
echo starting
set "robloxDirectory=C:\Users\folio\AppData\Local\Bloxstrap\Versions"
...
start "" "C:\Users\folio\AppData\Local\Bloxstrap\Versions\" 2>nul
timeout /t 3 /nobreak
goto menu
...
:deleteRobloxFolder1
for /d %%a in ("C:\Users\folio\AppData\Local\Bloxstrap\Versions\version-*") do (
    if exist "%%a\ClientSettings" (
